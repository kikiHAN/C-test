  ...
  <div class="container">
    <div class="col-lg-6 col-sm-8 p-0">
      <ul class="nav nav-pills" role="tablist">
        <li class="bg-pin"><a id="newBtn"  href="javascript:;">新增商品</a></li>
    ...
    <div class="col-lg-3 col-lg-offset-3 col-sm-4 ">
        <div class="input-group">
          <input id="searInp" type="text" class="form-control">
    ...
    <table class="table table-bordered table-striped table-hover mt-20 mb-20">
      <thead>
        <tr>
          ...
          <th>介绍</th>
          <th class="wt-100">库存</th>
          <th class="wt-100">类别</th>
        </tr>
      </thead>
      <tbody id = "tbody">
        <!-- <tr>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span id="close" class="sr-only">Close</span></button>
          <h4 class="modal-title" id="daltit">新增商品</h4>
        </div>
        <div class="modal-body">
            <form id ="gForm" class="form-horizontal">
            <input id="ghid" type="hidden" value="0">
        ...
        <div class="modal-footer">
          <button id="def" type="button" class="btn btn-default" data-dismiss="modal" >取消</button>
